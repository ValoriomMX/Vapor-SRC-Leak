...
public class ParserUtils
{
    ...
    static {
        ParserUtils.CHAR_MATCHER_ASCII = CharMatcher.inRange('0', '9').or(CharMatcher.inRange('a', 'z')).or(CharMatcher.inRange('A', 'Z')).or(CharMatcher.WHITESPACE).precomputed();
    }
    ...
    public static boolean isAlphanumeric(final String string) {
        return ParserUtils.CHAR_MATCHER_ASCII.matchesAllOf((CharSequence)string);
    }
