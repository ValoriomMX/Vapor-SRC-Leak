...
public class ChatUtil
{
    public static String getName(final ItemStack stack) {
        ...
        return String.valueOf(stack.getItem().a(stack)) + ".name";
    }
        ...
        if (stack.getType() == Material.POTION && stack.getData().getData() == 0) {
            ...
            if (potion != null) {
                ...
                if (type != null && type != PotionType.WATER) {
                    final String effectName = String.valueOf(potion.isSplash() ? "Splash " : "") + WordUtils.capitalizeFully(type.name().replace('_', ' ')) + " L" + potion.getLevel();
