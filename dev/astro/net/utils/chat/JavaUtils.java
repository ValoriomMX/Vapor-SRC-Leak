...
public class JavaUtils
{
    ...
    private static int DEFAULT_NUMBER_FORMAT_DECIMAL_PLACES;
    
    static {
        JavaUtils.DEFAULT_NUMBER_FORMAT_DECIMAL_PLACES = 5;
        JavaUtils.CHAR_MATCHER_ASCII = CharMatcher.inRange('0', '9').or(CharMatcher.inRange('a', 'z')).or(CharMatcher.inRange('A', 'Z')).or(CharMatcher.WHITESPACE).precomputed();
        JavaUtils.UUID_PATTERN = Pattern.compile("[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[34][0-9a-fA-F]{3}-[89ab][0-9a-fA-F]{3}-[0-9a-fA-F]{12}");
    }
